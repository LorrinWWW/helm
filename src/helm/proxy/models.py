...
ALL_MODELS = [
    ...
    Model(
        group="together",
        creator_organization="Meta",
        name="together/opt-125m",
        display_name="OPT (125M)",
        # From https://arxiv.org/pdf/2205.01068.pdf
        description="Open Pre-trained Transformers (125M parameters) is a suite of decoder-only pre-trained "
        "transformers that are fully and responsibly shared with interested researchers.",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, ABLATION_MODEL_TAG, OPT_TOKENIZER_TAG],
    ),
    # Microsoft/NVIDIA
    ...
    Model(
        group="together",
        creator_organization="Together",
        name="together/GPT-JT-6B-v1-delta2bit",
        display_name="GPT-JT (6B)",
        description="GPT-JT (6B parameters) is a fork of GPT-J",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTJ_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/gpt-jt-x-6b-v1.1",
        display_name="GPT-JT (6B)",
        description="GPT-JT (6B parameters) is a fork of GPT-J",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTJ_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/red-pajama-80B-tokens",
        display_name="Red Pajama (6.9B)",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/red-pajama-160B-tokens",
        display_name="Red Pajama (6.9B)",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/red-pajama-240B-tokens",
        display_name="Red Pajama (6.9B)",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/red-pajama-280B-tokens",
        display_name="Red Pajama (6.9B)",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/red-pajama-400B-tokens",
        display_name="Red Pajama (6.9B)",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/red-pajama-440B-tokens",
        display_name="Red Pajama (6.9B)",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/red-pajama-500B-tokens",
        display_name="Red Pajama (6.9B)",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/red-pajama-600B-tokens",
        display_name="Red Pajama (6.9B)",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/red-pajama-700B-tokens",
        display_name="Red Pajama (6.9B)",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/red-pajama-720B-tokens",
        display_name="Red Pajama (6.9B)",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/red-pajama-800B-tokens",
        display_name="Red Pajama (6.9B)",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/red-pajama-880B-tokens",
        display_name="Red Pajama (6.9B)",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/red-pajama-3B-240B-tokens",
        display_name="Red Pajama (2.7B)",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/red-pajama-3B-400B-tokens",
        display_name="Red Pajama (2.7B)",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/red-pajama-3B-500B-tokens",
        display_name="Red Pajama (2.7B)",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/red-pajama-3B-600B-tokens",
        display_name="Red Pajama (2.7B)",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/red-pajama-3B-700B-tokens",
        display_name="Red Pajama (2.7B)",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/red-pajama-3B-800B-tokens",
        display_name="Red Pajama (2.7B)",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/red-pajama-3B-940B-tokens",
        display_name="Red Pajama (2.7B)",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/red-pajama-80B-tokens-fix",
        display_name="Red Pajama (6.9B)",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/red-pajama-160B-tokens-fix",
        display_name="Red Pajama (6.9B)",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/rp-i-7b-jt-dehelm",
        display_name="Red Pajama (6.9B)",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/rp-i-3b-jt-dehelm",
        display_name="Red Pajama (3B)",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
    ...
    Model(
        group="together",
        creator_organization="Together",
        name="together/stablelm-base-alpha-7b-fix2",
        display_name="stablelm-base-alpha-7b-fix2",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/hb-150m",
        display_name="hb-150m",
        description="",
    ...
    Model(
        group="together",
        creator_organization="Together",
        name="together/pythia-3b",
        display_name="pythia-3b",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
    ...
    Model(
        group="together",
        creator_organization="Together",
        name="together/gpt-neo-3b",
        display_name="gpt-neo-3b",
        description="",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
    ...
    Model(
        group="together",
        creator_organization="Together",
        name="together/oasst-sft-7-llama-30b",
        display_name="oasst-sft-7-llama-30b",
        description="",
    ...
    Model(
        group="together",
        creator_organization="Together",
        name="together/oasst-sft-7-llama-30b-fix",
        display_name="oasst-sft-7-llama-30b",
        description="",
        tags=[TEXT_MODEL_TAG, LIMITED_FUNCTIONALITY_TEXT_MODEL_TAG, CHATML_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/bloom-ock-dolly-oasst1",
        display_name="Bloom",
        description="",
        tags=[TEXT_MODEL_TAG, LIMITED_FUNCTIONALITY_TEXT_MODEL_TAG, CHATML_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
    Model(
        group="together",
        creator_organization="Together",
        name="together/bloom-ock-dolly-oasst1-hf",
        display_name="Bloom",
        description="",
        tags=[TEXT_MODEL_TAG, LIMITED_FUNCTIONALITY_TEXT_MODEL_TAG, CHATML_MODEL_TAG, GPTNEO_TOKENIZER_TAG],
    ),
